      ...
      <div className="p-6 space-y-6">
        ...
        <Card className="border-gray-200 shadow-sm">
          ...
          <CardContent className="p-6">
            {dashboardData.completedRecordings.length === 0 ? (
              <div className="text-center py-8">
                <PlayCircle className="h-12 w-12 text-gray-300 mx-auto mb-3" />
                <p className="text-gray-500">No completed recordings yet</p>
                <p className="text-gray-400 text-xs mt-1">Recordings will appear here after your trainer uploads class recordings</p>
              </div>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {[...dashboardData.completedRecordings].reverse().map((recording) => (
                  <div
                    key={recording._id}
                  ...
                  >
                    ...
                    <div className="p-4">
                      <h4 className="font-medium text-gray-900 text-lg">{recording.moduleTitle}</h4>
          ...
          <CardContent className="p-6">
            {dashboardData.scheduledClasses.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-400 text-xs mt-1">Your trainer will schedule classes soon</p>
              </div>
            ) : (
                ...
                {dashboardData.scheduledClasses.map((classItem) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      {(classItem.canJoin || classItem.isLive) && classItem.bbbJoinUrl && (
                        <Button
                          size="sm"
