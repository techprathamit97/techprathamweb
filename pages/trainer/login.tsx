          ...
          <CardContent className="text-center space-y-4">
            <div className="bg-orange-100 p-4 rounded-lg">
              <p className="text-orange-800 font-medium mb-2">
                Trainer login has been moved to the unified login page
              </p>
            ...
            <div className="mt-6 p-3 bg-green-50 rounded-lg text-left">
              <p className="text-green-800 font-medium text-sm mb-1">What's new:</p>
              <ul className="text-green-700 text-xs space-y-1">
                <li>• Single login page for all users</li>
                <li>• Use your Trainer ID or email</li>
...
export default TrainerLoginDeprecated;